            ...
            listeners: {
                recordselected: function (record) {
                    ...
                    me.down('abstractform').getForm().setValues({
                          ...
                          PaymentTermsName: record.data.PaymentTerms.Description,
                          DeliveryTermsName : record.data.DeliveryTerms.Name,
                          ...
                          ExecutiveId : record.data.SalesExecutive.ExecutiveId,
                          PaymentTermsId: record.data.PaymentTerms.PaymentTermsId,
                          DeliveryTermId : record.data.DeliveryTerms.DeliveryTermId
                    });
            ...
            if(RequestManager) {
                ...
                if(data && data.responseText) {
                      ...
                      form.setValues({
                          ...
                          PaymentTermsName: master.PaymentTerms.Description,
