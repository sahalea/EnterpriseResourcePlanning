/**
* @class Erp.view.lookups.ItemSize
* @extend Ext.window.Window
*/
Ext.define("Erp.view.lookups.ItemSize", {
    extend: 'Ext.window.Window',
    alias: 'widget.itemsize',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            html: 'To add size , click Add. To change a size , select the group' +
                    ...
                    items: [
                        {
                            ...
                            keyField: 'ItemSizeId',
                            urls: {
                                save: serviceEndPointBase + 'api/itemsize/save'
