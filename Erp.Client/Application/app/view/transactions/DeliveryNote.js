            ...
            listeners: {
                recordselected: function (record) {
                    ...
                    me.down('abstractform').getForm().setValues({
                          ...
                          ProjectName : record.data.SalesOrderMaster.Projects.Name,
                          CustomerContactName : record.data.SalesOrderMaster.CustomerContacts.Name,
                          CustomerPO: record.data.SalesOrderMaster.Customers.PostBox,
                          ExecutiveName : record.data.SalesOrderMaster.SalesExecutive.Name
                    });
                }
            }
        });
