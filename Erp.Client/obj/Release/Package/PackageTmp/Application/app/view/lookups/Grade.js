/**
* @class Erp.view.lookups.Grade
* @extend Ext.window.Window
*/
Ext.define("Erp.view.lookups.Grade", {
    extend: 'Ext.window.Window',
    alias: 'widget.grade',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            html: 'To add Grade , click Grade. To change a Grade , select the group' +
                    ...
                    items: [
                        {
                            ...
                            keyField: 'GradeId',
                            urls: {
                                save: serviceEndPointBase + 'api/grade/save'
