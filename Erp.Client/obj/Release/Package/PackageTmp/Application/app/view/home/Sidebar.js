        ...
        items: [
            {
                ...
                html: '<div class="erp-info-panel-title">Login Time</div><div>' + Ext.Date.format(new Date(), 'g:i a') + '</div><br/>' +
                             ...
                             '<div class="erp-info-panel-title">Login User</div><div>Sahel</div><br/>' +
                             '<div class="erp-info-panel-title">Company</div><div>Al-Fuzail Group</div><br/>' +
                             '<div class="erp-info-panel-title">System Date Time</div><div id="inventory-clock">' + Ext.Date.format(new Date(), 'n/d/Y g:i a') + '</div>',
